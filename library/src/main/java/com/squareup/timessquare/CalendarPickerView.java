 ...
 * {@link #getSelectedDate()}.RecyclerView
 */
public class CalendarPickerView extends RecyclerView {
    ...
    private int dayBackgroundResId; //编辑
    private int dayTextColorResId;  //字体
    private int titleTextColor; //头部
...
//        adapter = new MonthAdapter();
        ...
        // TODO: 2016/4/20 RecyclerView 没有注释掉（ListView可以打开）
//    setDivider(null);
//    setDividerHeight(0);
//    setCacheColorHint(bg);
        ...
        // TODO: 2016/4/20 RecyclerView 适配器
...
//        if (getAdapter() == null) {
//            // TODO: 2016/4/20 ListView 使用
////            setAdapter(adapter);
//            // TODO: 2016/4/21  修改成RecyclerView使用
//            setAdapter(headersMonthAdapter);
//        }
//        if(null != adapter){
//            adapter.notifyDataSetChanged();
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                if (smoothScroll) {
                    ...
                    // TODO: 2016/4/20 修改成RecyclerView使用

...
public class LunarCalendar {
     ...
     * @param month_log 月
     * @param day_log   日
     * @param isday     false只返回节假日名称  true如果是节假日就返回节假日名称不就是返回日期
     * @return
     */
    ...
    public String toString() {
        if (chineseNumber[month - 1] == "一" && getChinaDayString(day) == "初一")
            ...
            return getChinaDayString(day);
        // return year + "年" + (leap ? "闰" : "") + chineseNumber[commons_month -
        // 1] +
	 ...
	 * com.squareup.timessquare.LunarCalendar().getLunarDate(2012, 1, 23)); }
	 */
